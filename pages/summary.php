    ...
    <content>
      <div class="wrapper s_date_info">
        <div class="box_date_info">
          <p>Atten. Date : <?php echo date("j F Y", strtotime($date))." - Shift ".$shift ?></p>
      ...
      <div class="s_boxLocation">
        <div class="wrapper">
          ...
          <table>
            ...
            <tbody>
              <tr <?php echo ($r_opt_belaz_2 < $opt_belaz_2) ? "class='bgred'" : ""?>>
                <td><i class="fa fa-truck-monster"></i>Operator Belaz</td>
                <td ><?php echo $r_opt_belaz_2?></td>
                <td><?php echo $opt_belaz_2?></td>
              </tr>
              <tr <?php echo ($r_opt_shovel_2 < $opt_shovel_2) ? "class='bgred'" : ""?>>
                <td><i class="fa fa-truck-loading"></i>Operator Shovel</td>
                <td><?php echo $r_opt_shovel_2?></td>
                <td><?php echo $opt_shovel_2?></td>
              </tr>
              <tr <?php echo ($r_opt_FM_2 < $opt_FM_2) ? "class='bgred'" : ""?>>
                <td><i class="fa fa-crown"></i>Foreman / GL</td>
                <td><?php echo $r_opt_FM_2?></td>
                <td><?php echo $opt_FM_2?></td>
              </tr>
              <tr <?php echo ($r_opt_PMB_2 < $opt_PMB_2) ? "class='bgred'" : ""?>>
                <td><i class="fa fa-street-view"></i>Pemandu Belaz</td>
                <td><?php echo $r_opt_PMB_2?></td>
                <td><?php echo $opt_PMB_2?></td>
              </tr>
              <tr <?php echo ($r_opt_PMS_2 < $opt_PMS_2) ? "class='bgred'" : ""?>>
                <td><i class="fa fa-user-cog"></i>Pemandu Shovel</td>
                <td><?php echo $r_opt_PMS_2?></td>
                <td><?php echo $opt_PMS_2?></td>
              </tr>
              <tr <?php echo ($r_opt_GD_2 < $opt_GD_2) ? "class='bgred'" : ""?>>
                <td><i class="fa fa-road"></i>Operator Gradder</td>
                <td><?php echo $r_opt_GD_2?></td>
                <td><?php echo $opt_GD_2?></td>
              </tr>
              <tr <?php echo ($r_opt_DZ_2 < $opt_DZ_2) ? "class='bgred'" : ""?>>
                <td><i class="fa fa-snowplow"></i>Operator Dozer </td>
                <td><?php echo $r_opt_DZ_2?></td>
                <td><?php echo $opt_DZ_2?></td>
              </tr>
            </tbody>
          </table>
          <div class="btnDetail">
            <a href="#" ><i class="fa fa-info"></i> Attendance Detail </a>
          </div>
        </div>
        <div class="wrapper">
          ...
          <table>
            ...
            <tbody>
              <tr <?php echo ($r_opt_belaz_3 < $opt_belaz_3) ? "class='bgred'" : ""?>>
                <td><i class="fa fa-truck-monster"></i>Operator Belaz</td>
                <td><?php echo $r_opt_belaz_3?></td>
                <td><?php echo $opt_belaz_3?></td>
              </tr>
              <tr <?php echo ($r_opt_shovel_3 < $opt_shovel_3) ? "class='bgred'" : ""?>>
                <td><i class="fa fa-truck-loading"></i>Operator Shovel</td>
                <td><?php echo $r_opt_shovel_3?></td>
                <td><?php echo $opt_shovel_3?></td>
              </tr>
              <tr <?php echo ($r_opt_FM_3 < $opt_FM_3) ? "class='bgred'" : ""?>>
                <td><i class="fa fa-crown"></i>Foreman / GL</td>
                <td><?php echo $r_opt_FM_3?></td>
                <td><?php echo $opt_FM_3?></td>
              </tr>
              <tr <?php echo ($r_opt_PMB_3 < $opt_PMB_3) ? "class='bgred'" : ""?>>
                <td><i class="fa fa-street-view"></i>Pemandu Belaz</td>
                <td><?php echo $r_opt_PMB_3?></td>
                <td><?php echo $opt_PMB_3?></td>
              </tr>
              <tr <?php echo ($r_opt_PMS_3 < $opt_PMS_3) ? "class='bgred'" : ""?>>
                <td><i class="fa fa-user-cog"></i>Pemandu Shovel</td>
                <td><?php echo $r_opt_PMS_3?></td>
                <td><?php echo $opt_PMS_3?></td>
              </tr>
              <tr <?php echo ($r_opt_GD_3 < $opt_GD_3) ? "class='bgred'" : ""?>>
                <td><i class="fa fa-road"></i>Operator Gradder</td>
                <td><?php echo $r_opt_GD_3?></td>
                <td><?php echo $opt_GD_3?></td>
              </tr>
              <tr <?php echo ($r_opt_DZ_3 < $opt_DZ_3) ? "class='bgred'" : ""?>>
                <td><i class="fa fa-snowplow"></i>Operator Dozer </td>
                <td><?php echo $r_opt_DZ_3?></td>
